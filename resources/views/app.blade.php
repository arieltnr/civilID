    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <a href="index.html" class="navbar-brand mx-auto mx-lg-0 d-flex align-items-center">
                <img src="{{ asset('/storage/'.$modProfile->logo) }}" class="logo-navbar me-3" alt="Logo">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-12 col-12 border-bottom pb-5 mb-5">
                    <div class="d-flex">
                        <a href="index.html" class="navbar-brand mx-auto mx-lg-0 d-flex align-items-center">
                            <img src="{{ asset('/storage/'.$modProfile->logo) }}"
                ...
                <div class="col-lg-5 col-12 ms-lg-auto">
                    <div class="copyright-text-wrap d-flex align-items-center">
                        <p class="copyright-text ms-lg-auto me-4 mb-0">Copyright © {{ $modProfile->tahun . ' '. $modProfile->nama_profil }}.
