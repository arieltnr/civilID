        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="{{ route('home') }}" class="logo">
              <img src="{{ Storage::url($modProfile->logo ?? 'default/logo.png') }}" class="logo-navbar me-3" alt="Logo" class="image">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image">
            ...
            $images = [];
            if (!empty($kegiatan->gambar1)) $images[] = $kegiatan->gambar1;
            if (!empty($kegiatan->gambar2)) $images[] = $kegiatan->gambar2;
            if (!empty($kegiatan->gambar3)) $images[] = $kegiatan->gambar3;
            if (!empty($kegiatan->gambar4)) $images[] = $kegiatan->gambar4;
          ...
          <div class="accordions is-first-expanded">
            <article class="accordion">
              <div>
                ...
                <hr>
                <span style="font-style: italic; font-size: 13px;">{{ $kegiatan->tgl_kegiatan_indo }}</span>
              </div>
              <div>
                <div class="content">
                  <p>{!! $kegiatan->isi_kegiatan !!}
                  </p>
                </div>
              </div>
            </article>
